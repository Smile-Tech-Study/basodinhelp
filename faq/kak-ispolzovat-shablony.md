...
Важно: у методиста, назначаемого ответственным, должен быть создан аккаунт У2035 и присвоен UNTI ID. То есть при регистрации в системе следует войти через у2035 и проверить, что в профиле появился UNTI ID, и что он такой же, как на у2035.

![](./kak-ispolzovat-shablony-16.png){width=510px height=490px}
