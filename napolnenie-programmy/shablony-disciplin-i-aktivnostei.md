---
title: Шаблоны дисциплин и активностей
order: 4
---
...
Подробнее о том, как быстро и эффективно использовать шаблоны при создании образовательных программ, а также о порядке их применения вы можете узнать в статье [«Как создавать программы и использовать шаблоны?»](./../faq/kak-ispolzovat-shablony)