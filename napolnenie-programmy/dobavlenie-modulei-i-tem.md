...
Чтобы добавить или изменить описание модуля или темы, нажмите на значок **документа** рядом с их названием (появляется при наведении на строку с названием модуля/темы).

![](./dobavlenie-modulei-i-tem-2.png){width=1492px height=1074px}
...
![](./dobavlenie-modulei-i-tem-3.png){width=966px height=160px}
