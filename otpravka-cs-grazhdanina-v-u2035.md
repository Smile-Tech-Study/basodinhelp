...
Далее следует загрузите скан заполненного и подписанного дневника практики (если программа не дистанционная) по каждому студенту, а также при необходимости прочие документы, которые надо передать в составе данного отчета.
...
После загрузки необходимых файлов отчет будет отправлен. Если отчет уже отправлен, то вы увидите соответствующий статус "Отправлено в У2035». Если программа дистанционная, то дневник практики не надо загружать.
